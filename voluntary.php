...
<div id="wrapper-holder">
		<div id="wrapper">
			...
			<div class="content_about content_block">
				<div id="content">
				<p style="color:#00CED1;font-size:xx-large;  text-align: center;padding-top:5px;">Волонтерство</p>
					<div style="padding-left:23px;padding-right:25px;">
						<div style="padding-right:80px;">
						<p style="text-align:right;">«Настанет время, когда человечество будет</p><p style="text-align:right;"> гуманным к каждому существу, которое дышит»</p>
						<p style="text-align:right;">Джереми Бентам</p></div>
						<p>Помимо обеспечения доставки питания питомцам, которые имеют хозяев, команда MeowGav  пришла к выводу, что социальной миссией проэкта должна стать и помощь тем животным, которые не получают любви, тепла и заботы. Именно поэтому организован этот раздел, в котором будет публиковаться исчерпывающая информация об волонтерских программах и благотворительных акциях. </p>
						<p>Целью этих мероприятий является донесение до общества таких проблем как: большое количество бездомных животных, недостаточное количество приютов и их финансирования, проблема распространения ДТП с участием животных и т.д. Мы глубоко надеемся сплотить социально активную часть общества, что бы сделать всё возможное в изменении окружения в лучшую, в более гуманную сторону.</p>
						<div style="padding-right:80px;font-size:10;"><p style="text-align:right;">С уважением, штат волонтёров MG</p></div>
					</div>
				</div>
			</div>
</div>
